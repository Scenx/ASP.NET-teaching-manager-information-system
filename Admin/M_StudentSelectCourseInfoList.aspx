    ...
    <asp:Repeater ID="RpStudentSelectCourseInfo" runat="server" onitemcommand="RpStudentSelectCourseInfo_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="M_EditStudentSelectCourseInfo.aspx?selectId=<%#Eval("selectId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("selectId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
