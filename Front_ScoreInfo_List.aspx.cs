...
{
    public partial class Front_ScoreInfo_List : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Front_ScoreInfo_List.aspx?studentNumber=" + studentNumber.SelectedValue.Trim() + "&&courseNumber=" + courseNumber.SelectedValue.Trim());
        }
    }
}
