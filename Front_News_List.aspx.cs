...
{
    public partial class Front_News_List : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Front_News_List.aspx?newsTitle=" + newsTitle.Text.Trim() + "&&newsDate=" + newsDate.Text.Trim());
        }
    }
}
