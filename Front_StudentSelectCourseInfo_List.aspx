<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Front_StudentSelectCourseInfo_List.aspx.cs" Inherits="shuangyulin.Front.Front_StudentSelectCourseInfo_List" %>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">选课信息管理 》》选课信息列表</div>
    ...
    <asp:Repeater ID="RpStudentSelectCourseInfo" runat="server">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="Front_StudentSelectCourseInfo_Details.aspx?selectId=<%#Eval("selectId") %>">查看</a>
             </tr>
        </ItemTemplate>
